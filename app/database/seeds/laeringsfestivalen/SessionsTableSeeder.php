...
class SessionsTableSeeder extends  \Seeder {
	...
	private function createSessions($conferenceId)
	{
		...
		$session_7 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 2: Digital undervisning og omvendt klasserom',
		...
		$session_8 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 2: Innovativ Utdanning ved NTNU',
		...
		$session_11 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 2: Organisering av støttetjenester – spiller det noen rolle?',
		...
		$session_12 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 2: Endringskompetanse for bedre læringsstøtte',
			'description' => '',
			'location' => 'Auditorium EL 6',
			'category' => 'professional',
			'confirmed' => true,
		...
		$session_20 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 1: Digital eksamen. Fra behov til gjennomføring',
		...
		$session_21 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 1: Juridiske aspekter ved digital eksamen',
		...
		$session_22 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 2: Digital tilstand 2014, fra undervisning til læring - et spørsmål om utdanningsledelse?',
		...
		$session_23 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 2: Digitalisering for kvalitet - Hva må gjøres?',
			'description' => '',
			'location' => 'Auditorium EL 6',
			'category' => 'professional',
			'confirmed' => true,
		...
		$session_28 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 1: Ideelt digitalt læringsmiljø',
			'description' => '',
			'location' => 'Auditorium EL 5',
			'category' => 'professional',
			'confirmed' => true,
		...
		$session_29 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 1: Eksisterer den "digitale" studenten? Om studenters prioriteringer og personlige ressurser',
		...
		$session_30 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 2: Opphavsrett - erfaringer som viser utfordringer – Faglærerperspektiv',
			'description' => '',
			'location' => 'Auditorium EL 6',
			'category' => 'professional',
			'confirmed' => true,
		...
		$session_31 = Session::create([
			'conference_id' => $conferenceId,
			'title' => 'SPOR 2: DelRett hjelper deg – opphavsrett og undervisning',
